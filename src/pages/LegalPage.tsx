...
const content: Record<string, { title: string; eyebrow: string; sections: { h: string; p: string }[] }> = {
  terms: {
    ...
    sections: [
      { h: "1. Acceptance of terms", p: "By accessing Funded Ox, you agree to these terms. All trading accounts are simulated demo environments unless explicitly stated otherwise." },
      { h: "2. Eligibility", p: "You must be 18+ and legally able to enter into contracts in your jurisdiction. Funded Ox is not available in restricted countries." },
      ...
      { h: "5. Limitation of liability", p: "Funded Ox is not a broker. Nothing on this site constitutes financial advice. Trading involves substantial risk." },
    ],
  },
  privacy: {
    eyebrow: "Legal",
  ...
  risk: {
    ...
    sections: [
      ...
      { h: "Simulated environment", p: "Funded Ox accounts are simulated. Past simulated performance does not guarantee future results in live markets." },
      { h: "No advice", p: "Nothing published by Funded Ox constitutes investment, legal or tax advice. Consult a licensed professional." },
    ],
  },
};
