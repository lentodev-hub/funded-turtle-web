  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        turtle: {
          shell: "hsl(var(--turtle-shell))",
          glow: "hsl(var(--turtle-glow))",
        },
        gold: {
      ...
      keyframes: {
        ...
        "swim": {
          ...
          "50%": { transform: "translateX(0) translateY(-18px) rotate(-3deg)" },
      ...
      animation: {
        ...
        "flipper-left": "flipper-left 2s ease-in-out infinite",
        "flipper-right": "flipper-right 2s ease-in-out infinite",
